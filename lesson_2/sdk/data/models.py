...
from lesson_2.data import config
...
class Networks:
    ...
    Celo = Network(
        ...
        api=API(
            key=config.CELO_API_KEY, url="https://api.celoscan.io/api", docs="https://docs.celoscan.io/"
        )
    )
    ...
    HECO = Network(
        ...
        api=API(
            ...
            docs="https://github.com/stars-labs/heco-chain-docs/blob/master/intro.md"
        )
    )
