'''
1) написать функцию swap_usdc_to_eth для SpaceFi
2) написать функцию swap_usdc_to_eth для SyncSwap
3) перенести abi SpaceFi в json файл (в аби должно быть 2 функции для свапа эфира и токенов)
4) написать функици для ввода средств и вывода через официальный мост
'''
