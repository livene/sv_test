...
from private_data import private_key2, proxy
...
async def main():
    client = Client(private_key=private_key2, network=Networks.Arbitrum)
    ...
    # print(await tx.parse_params(client=client))
    # print(await tx.decode_input_data(client=client, contract=Contracts.ARBITRUM_WOOFI))
    # tx_hash = '0x3a8478088d0882400060fa106fe997cd219121aafd9f2be3e987dc18a08a8f66'
    # tx = Tx(tx_hash=tx_hash)
    # print(tx)
    # print(await tx.parse_params(client=client))
    # print(await tx.decode_input_data(client=client, contract=Contracts.ARBITRUM_WOOFI))
